...
(function(){
    ...
    Options.createOptions = function(){
        ...
        var invertScrollCheckbox = PrefMaker.makeBooleanCheckbox('invertScroll', 'Invert Scroll', 'Use the opposite direction as you do in your system preferences');
        box.append(invertScrollCheckbox);

        var invertZoomCheckbox = PrefMaker.makeBooleanCheckbox('invertZoom', 'Invert Zoom', 'Recommended for "natural" scrolling direction users');
