var ScrollMapsOptionsPanel = new (function _ScrollMapsOptionsPanel(){
    ...
    self.createButton = function(){
        var bg = Extension.getURL('images/button_active.png');
        var bottom = window.safari ? 30 : 19;
        var div = $('<div id="SCROLLMAP_optionsbutton" style="display: block; height: 20px; position: absolute; bottom: ' + bottom + 'px; right: 0px; background: #FFF; z-index: 999999; border: 1px solid #999; box-sizing: border-box;"></div>');
        ...
        var optionsLink = Extension.getURL('options/options.html');
