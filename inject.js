var ScrollMapsOptionsPanel = new (function _ScrollMapsOptionsPanel(){
    ...
    self.createButton = function(){
        var bg = safari.extension.baseURI + 'button_active.png';
        var div = $('<div id="SCROLLMAP_optionsbutton" style="display: block; height: 20px; position: absolute; bottom: 27px; right: 0px; background: #FFF; z-index: 999999; border: 1px solid #999; box-sizing: border-box;"></div>');
        ...
        var optionsLink = safari.extension.baseURI + 'options/options.html';
